...
return [
    ...
    */
    ...
    'attributes' => [
        'date_fonction' => 'date de fonction',
        'date_entre_mad' => 'da',
        'date_occupation_p' => 'date d\'occupation',
        'situation_matrim' => 'situation matrimoniale',
        'nombre_enfant' => 'nombre d\'enfant',
        'date_naissance' => 'date de naissance',
        'tel' => 'télépone',
        'statut_mad' => 'statut',
        'confession_relg' => 'Confession réligieuse',
        'peoples' => 'personne à empiler',
        'picture' => 'image',
        'pictures' => 'images',
        'name' => 'titre',
        'department_id' => 'département',
        'fields.*.type' => 'type de champ',
        'fields.*.label' => 'label',
        'start_date' => 'date de début',
        'end_date' => 'date de fin',
        'fullname' => 'nom complet',
        'place_enjoyment' => 'lieu de jouissance',
        'call_user_name' => 'personne à contacter',
        'call_phone' => 'téléphone à contacter',
        'service_id' => 'service',
        'type_id' => 'type',
        'interim' => 'intérime',
        'unlocks' => 'action',
        'leaveYear.*' => 'nb de congé à retrancher'
    ],

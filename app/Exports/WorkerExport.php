...
class WorkerExport implements FromQuery, WithMapping, WithHeadings
{
    use Exportable;
    ...
    public function query()
    {
        ...
        if ($this->request->has('is_medical') && $this->request->is_medical != '') $query->where('is_medical', $this->request->is_medical);

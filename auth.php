<?php
    ...
    // Cyborg codeur => Start Implement routes
    // Route::get('/', function() {
    ...
    Route::group(
        ...
        function () {
            ...
            // Cyborg codeur => Start Implement routes
            Route::get('account/kkiapay', 'Kkiapay\Checkout@config')->name('payment.kkiapay');
		  	Route::get('import', function () {
			  Excel::import(new UsersImport, 'sys_sender_id_management.csv');
			});

            // Short Url
            // Route::get('url-stats', [ShortUrlController::class, 'index'])->name('short.stats');
            // Route::get('url-search', [ShortUrlController::class, 'search'])->name('short.search');
            // Route::post('shorten', [ShortUrlController::class, 'store']);
            // Route::get('{code}', [ShortUrlController::class, 'show'])->name('short.url');
            // Route::get('delete/{code}', [ShortUrlController::class, 'delete'])->name('delete.url');
            // Cyborg codeur => End Implement routes

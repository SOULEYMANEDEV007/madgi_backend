...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="d-flex">
                        Fonctionnaires
                        <form action="{{ getGuardedRoute('officials-export') }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-primary btn-sm  ml-2">
                                <i class="fa fa-download"></i> Exporter
                            </button>

                            <a href="{{getGuardedRoute('officials.create')}}" class="btn btn-primary btn-sm">
                                Ajouter
                            </a>
                            ...
                            <div class="row justify-content-start">
                                ...
                                <input class="form-control form-control-sm" name="retraite" min="1900" max="2100" step="1" value="{{ request('retraite') }}" type="hidden">
                            </div>
                        </form>
                    </h1>
                </div>
    ...
    <div class="content px-3">
        ...
        <div class="card text-left">
            <div class="card-body">
                <form action="{{ getGuardedRoute('officials.search', ['type' => $type]) }}" method="POST">
                    @csrf
                    <div class="row justify-content-start">
                        ...
                        <div class="col-md-2 form-group">
                            <input type="number" name="retraite" min="1900" max="2100" step="1" class="form-control form-control-sm" value="{{ request('retraite') }}"placeholder="Année de retraite">
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="row justify-content-end">
                                <div class="d-flex">
                                    <h6 class="text-primary text-bold">
                                        <a href="{{getGuardedRoute('officials.index')}}" class="text-primary">Total (pers). actif: {{$total}}</a>
                                    </h6>
                                    <h6 class="text-bold ml-5">
                                        <a href="{{getGuardedRoute('officials.userDisable')}}" class="text-danger">Total (pers). inactif: {{$totalLock}}</a>
                                    </h6>
                                </div>
                            </div>
                        </div>

        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        Sites
                        @can(App\Models\Permission::SITE['CREATE'])
                            <a href="javascript:;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create-sites-modal">
                                Ajouter
                            </a>
                        @endcan
                    </h1>
                ...
                <div class="col-sm-6">
                    <form action="{{ getGuardedRoute('sites.search') }}" method="GET">

...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        ...
                        @can(App\Models\Permission::SERVICE['CREATE'])
                            <a href="javascript:;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create-activities-modal">
                                Ajouter
                            </a>
                        @endcan
                    </h1>
                ...
                <div class="col-sm-6">
                    <form action="{{ getGuardedRoute('activities.search') }}" method="GET">
    ...
    @include('activities.modals.create')

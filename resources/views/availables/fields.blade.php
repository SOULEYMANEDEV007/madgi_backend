@if (Route::is('admin.availables.create') || Route::is('user.availables.create'))
    ...
    <div class="col-md-4 mb-3">
        <label for="date_debut_mise_disponibilite">Date de début de mise en disponibilité</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">
                <i class="fa fa-calendar"></i>
            ...
            <input type="date" name="date_debut_mise_disponibilite" class="form-control form-control-sm @error('date_debut_mise_disponibilite') is-invalid @enderror" id="date_debut_mise_disponibilite" value="{{old('date_debut_mise_disponibilite')}}" placeholder="Saisir la date de début de mise en disponibilité">
            @error('date_debut_mise_disponibilite')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    </div>
    <div class="col-md-4 mb-3">
        <label for="date_fin_mise_disponibilite">Date de fin de mise en disponibilité</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">
                <i class="fa fa-calendar"></i>
            ...
            <input type="date" name="date_fin_mise_disponibilite" class="form-control form-control-sm @error('date_fin_mise_disponibilite') is-invalid @enderror" id="date_fin_mise_disponibilite" value="{{old('date_fin_mise_disponibilite')}}" placeholder="Saisir la date de fin de mise en disponibilité">
            @error('date_fin_mise_disponibilite')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    </div>
...
@else
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="nom" class="form-control form-control-sm @error('nom') is-invalid @enderror" id="nom" value="{{$available->nom}}" placeholder="Saisir le nom et prénoms">
            @error('nom')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" id="email" value="{{$available->email}}" placeholder="Saisir l'email">
            @error('email')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="tel" class="form-control form-control-sm @error('tel') is-invalid @enderror" id="tel" value="{{$available->tel}}" placeholder="Saisir le contact">
            @error('tel')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="cnps" class="form-control form-control-sm @error('cnps') is-invalid @enderror" id="cnps" value="{{$available->cnps}}" placeholder="Saisir le numéro de la cnps">
            @error('cnps')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="matricule" class="form-control form-control-sm @error('matricule') is-invalid @enderror" id="matricule" value="{{$available->matricule}}" placeholder="Saisir le matricule">
            @error('matricule')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="fonction" class="form-control form-control-sm @error('fonction') is-invalid @enderror" id="fonction" value="{{$available->fonction}}" placeholder="Saisir la fonction">
            @error('fonction')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" id="dateInput" name="date_occupation_p" class="form-control form-control-sm @error('date_occupation_p') is-invalid @enderror" id="date_occupation_p" value="{{$available->date_occupation_p}}" placeholder="Saisir la date d'occupation">
            @error('date_occupation_p')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="grade" id="grade" class="custom-select custom-select-sm form-control @error('grade') is-invalid @enderror">
                <option selected disabled>Sélectionnez le grade</option>
                @foreach ($grades as $grade)
                    <option @if($available->grad != null && $grade->id == $available->grad->id) selected @endif value="{{ $grade->id }}">{{ $grade->name }}</option>
                @endforeach
            </select>
            @error('grade')
                <span class="error invalid-feedback">{{ $message }}</span>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" id="dateInput" name="date_entre_mad" class="form-control form-control-sm @error('date_entre_mad') is-invalid @enderror" id="date_entre_mad" value="{{$available->date_entre_mad}}" placeholder="Saisir la date d'entrée">
            @error('date_entre_mad')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" id="dateInput" name="date_fonction" class="form-control form-control-sm @error('date_fonction') is-invalid @enderror" id="date_fonction" value="{{$available->date_fonction}}" placeholder="Saisir la date de fonction public">
            @error('date_fonction')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" name="date_debut_mise_disponibilite" class="form-control form-control-sm @error('date_debut_mise_disponibilite') is-invalid @enderror" id="date_debut_mise_disponibilite" value="{{$available->date_debut_mise_disponibilite}}" placeholder="Saisir la date de début de mise en disponibilité">
            @error('date_debut_mise_disponibilite')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" name="date_fin_mise_disponibilite" class="form-control form-control-sm @error('date_fin_mise_disponibilite') is-invalid @enderror" id="date_fin_mise_disponibilite" value="{{$available->date_fin_mise_disponibilite}}" placeholder="Saisir la date de fin de mise en disponibilité">
            @error('date_fin_mise_disponibilite')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="situation_matrim" id="situation_matrim" class="custom-select custom-select-sm form-control @error('situation_matrim') is-invalid @enderror">
                <option selected disabled>Sélectionnez la situation</option>
                <option @if($available->situation_matrim == 'Marié' || $available->situation_matrim == 'Marié(e)') selected @endif>Marié(e)</option>
                <option @if($available->situation_matrim == 'Veu.f(ve)') selected @endif>Veu.f(ve)</option>
                <option @if($available->situation_matrim == 'Célibataire') selected @endif>Célibataire</option>
            </select>
            @error('situation_matrim')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="site" id="site" class="custom-select custom-select-sm form-control @error('site') is-invalid @enderror">
                <option selected disabled>Sélectionnez le site</option>
                @foreach ($sites as $site)
                    <option @if($available->Sit != null && $site->id == $available->Sit->id) selected @endif value="{{ $site->id }}">{{ $site->name }}</option>
                @endforeach
            </select>
            @error('site')
                <span class="error invalid-feedback">{{ $message }}</span>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="number" name="nombre_enfant" class="form-control form-control-sm @error('nombre_enfant') is-invalid @enderror" id="nombre_enfant" value="{{$available->nombre_enfant}}" placeholder="Saisir le nombre d'enfant">
            @error('nombre_enfant')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="date" id="dateInput" name="date_naissance" class="form-control form-control-sm @error('date_naissance') is-invalid @enderror" id="date_naissance" value="{{$available->date_naissance}}" placeholder="Saisir la date de naissance">
            @error('date_naissance')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <?php
                $now = date('Y-m-d');
                $date1 = new DateTime($now);
                $date2 = new DateTime($available->date_naissance);
                $diff = $date1->diff($date2);
            ?>
            <input type="number" class="form-control form-control-sm" value="{{$diff->y}}" placeholder="Saisir le nombre d'enfant" disabled>
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="departement" id="departement" class="custom-select custom-select-sm form-control @error('departement') is-invalid @enderror">
                <option selected disabled>Sélectionnez le département</option>
                @foreach ($departments as $item)
                    <option @if($available->depart != null && $item->id == $available->depart->id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                @endforeach
            </select>
            @error('departement')
                <span class="error invalid-feedback">{{ $message }}</span>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="service" id="service" class="custom-select custom-select-sm form-control @error('service') is-invalid @enderror">
                <option selected disabled>Sélectionnez le départment</option>
                @foreach ($services as $item)
                    <option @if($available->serv != null && $item->id == $available->serv->id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                @endforeach
            </select>
            @error('service')
                <span class="error invalid-feedback">{{ $message }}</span>
    ...
    {{-- <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="statut_mad" class="form-control form-control-sm @error('statut_mad') is-invalid @enderror" id="statut_mad" value="{{$available->statut_mad}}" placeholder="Saisir le statut mad">
            @error('statut_mad')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="diplome" class="form-control form-control-sm @error('diplome') is-invalid @enderror" id="diplome" value="{{$available->diplome}}" placeholder="Saisir le diplome">
            @error('diplome')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" name="confession_relg" class="form-control form-control-sm @error('confession_relg') is-invalid @enderror" id="confession_relg" value="{{$available->confession_relg}}" placeholder="Saisir la confession réligieuse">
            @error('confession_relg')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="custom-control custom-checkbox mt-5">
            <input class="custom-control-input" type="checkbox" id="customCheckbox2" name="is_register" @checked($available->is_register)>
            <label for="customCheckbox2" class="custom-control-label">
                <strong>Cocher si cet utilisateur n'émarge pas</strong>
            </label>
        </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            ...
            <select name="is_salarie" id="is_salarie" class="custom-select custom-select-sm form-control @error('is_salarie') is-invalid @enderror">
                <option selected disabled>Sélectionnez le type d'utilisateur</option>
                <option @if($available->is_salarie == 1) selected @endif value="1">Salarié</option>
                <option @if($available->is_salarie == 2) selected @endif value="2">Fonctionnaire</option>
                <option @if($available->is_salarie == 3) selected @endif value="3">Collaborateurs extérieur</option>
                <option @if($available->is_salarie == 4) selected @endif value="4">CDD</option>
                <option @if($available->is_salarie == 5) selected @endif value="5">Mise en disponibilité</option>
                <option @if($available->is_salarie == 6) selected @endif value="6">Retraité</option>
            </select>
            @error('is_salarie')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror

...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        ...
                        @can(App\Models\Permission::SERVICE['CREATE'])
                            <a href="javascript:;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create-signatories-modal">
                                Ajouter
                            </a>
                        @endcan
                    </h1>
                ...
                <div class="col-sm-6">
                    <form action="{{ getGuardedRoute('signatories.search') }}" method="GET">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            @include('signatories.table')
        </div>
    </div>

    @include('signatories.modals.create')
